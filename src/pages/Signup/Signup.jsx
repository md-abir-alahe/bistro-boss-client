                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input {...register("photoURL", { required: true })} type="name"  placeholder="photo url" className="input input-bordered" />
                            ...
                            <div className="form-control">
                                ...
                                {errors.password?.type === 'pattern' && <p className='text-red-600'>Password must have one upper case, one lower case and one special character</p>}
                        ...
                        <p><small>Already have an account. <Link to={`/signup`}>Please Login</Link></small></p>
                    </div>
                </div>
            </div>
        </>
